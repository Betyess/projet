...
def ajouter():
    ...
    cuser = con.cursor()
    cuser.execute("insert into patient('code','nom','prenom','age','adresse','telephone','remarque') values (?,?,?,?,?,?,?)",(matricule,nom,prenom,age,adresse,telephone,remarque))
    con.commit()
    con.close()
...
#titre general
root = Tk()
root.title("Gestion des participants ")
root.geometry("1300x700")


#Ajouter le titre
lbltitre = Label(root,bd = 20, relief = RIDGE, text = "GESTION DES PARTICIPANTS AU CONCOURS de FOOT", font = ("Arial", 30), bg = "darkblue", fg="white")
lbltitre.place(x = 0, y = 0, width = 1365)

#Liste des patients
lblListePatient = Label(root, text = "LISTES DES PARTICIPANTS ", font = ("Arial", 16), bg = "darkblue", fg="white")
lblListePatient.place(x=600,y=100,width=760)



#text matricule
lblmatricule = Label(root, text = "Matricule Participant", font = ("Arial", 16), bg = "black", fg="white")
lblmatricule.place(x=0,y=100,width=200)
entrermatricule = Entry(root)
entrermatricule.place(x=200,y=100,width=160,height=30)

#text nom
lblnom = Label(root, text = "Nom Participant", font = ("Arial", 16), bg = "black", fg="white")
lblnom.place(x=0,y=150,width=200)
entrernom = Entry(root)
entrernom.place(x=200,y=150,width=200,height=30)

#text prenom
lblPrenom = Label(root, text = "Prenom Participant", font = ("Arial", 16), bg = "black", fg="white")
...
#text adresse
lbladresse = Label(root, text = "Adresse Participant", font = ("Arial", 16), bg = "black", fg="white")
lbladresse.place(x=0,y=300,width=200)
entreradresse = Entry(root)
entreradresse.place(x=200,y=300,width="300",height=30)

#text Telephone
lbltelephone = Label(root, text = "Telephone Participant", font = ("Arial", 16), bg = "black", fg="white")
lbltelephone.place(x=0,y=350,width=200)
entrertelephone = Entry(root)
entrertelephone.place(x=200,y=350,width=200,height=30)

#text remarque
lblremarque = Label(root, text = "Remarque Participant", font = ("Arial", 16), bg = "black", fg="white")
